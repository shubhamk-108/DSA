/*
This question is lc premium. Same question on GFG.
...
// This is priority queue or heap problem so solve it in that playlist
...
{
    Solution sol;
    vector<int> v1 = {1, 10, 7};
    vector<int> v2 = {4, 15, 10};
    cout << sol.minMeetingRooms(v1, v2);
    return 0;
}
